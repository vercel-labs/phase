...
| `--write-baseline <path>` | Write all current finding fingerprints as a sorted baseline and exit 0. Cannot be combined with `--signal`, `--severity`, `--noise`, `--exclude`, or `--stdin0`                          |
