...
| `per-frame-allocation`           | critical | noisy   | Object/array literal or spread, `.map()`, or `.filter()` inside a proven recurring frame callback  | [performance.md](./performance.md#zero-per-frame-allocations)                                                              |
