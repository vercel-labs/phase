...
- Rely on the shared clock: all tickers receive the same browser rAF timestamp, even when a page loads duplicate phase copies that use the same clock protocol.
