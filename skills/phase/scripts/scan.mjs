...
const SIGNAL_CATALOG = [
	...
	{
		id: "setstate-in-raf",
		replacement: "write repeated values to a ref or the DOM; keep only guarded terminal updates that stop rescheduling",
	...
	},
	{
		...
		replacement: "write repeated values to a ref or the DOM; keep only guarded terminal updates that request shutdown in the same callback",
		...
		why: "State can reconcile at tick rate; inspect repeated versus terminal updates.",
		fix: "references/performance.md#never-write-repeated-state-inside-ontick--draw",
	...
	{
		id: "raw-io",
		replacement: "verify targets, output, ownership, and teardown; useSight/useLifecycle when contracts fit",
	...
	{
		id: "raw-ro",
		replacement: "verify targets, output, ownership, and teardown; useSize when contracts fit",
	...
	},
	{
		...
		replacement: "respect reduced motion unless it is non-decorative or a verified reactive parent supplies static output",
		label: "reducedMotion: 'ignore' (bypasses the user preference)",
		severity: "medium",
		noise: "precise",
		detects: "`reducedMotion: 'ignore'` (bypasses the user preference)",
		why: "Requires non-decorative motion or a verified reactive owner with static output.",
		fix: "references/performance.md#reduced-motion-by-default",
