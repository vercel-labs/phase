...
13. **version-preflight-routing.** Advisory routing scenario. The rubric checks repository preference, gated runtime coverage, and a read-only source-version nudge.
