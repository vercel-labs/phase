...
13. **version-preflight-routing.** Advisory routing scenario. The rubric checks repository preference, gated runtime contract verification, and a read-only source-version nudge.
