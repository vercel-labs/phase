...
const SIGNAL_CATALOG = [
  ...
  },
  {
    id: 'setstate-in-raf',
    replacement:
      'write repeated values to a ref or the DOM; keep only guarded terminal updates that stop rescheduling',
  ...
  },
  {
    ...
    replacement:
      'write repeated values to a ref or the DOM; keep only guarded terminal updates that request shutdown in the same callback',
  ...
  },
  {
    id: 'raw-io',
    replacement:
      'verify targets, output, ownership, and teardown; useSight/useLifecycle when contracts fit',
  ...
  },
  {
    id: 'raw-ro',
    replacement:
      'verify targets, output, ownership, and teardown; useSize when contracts fit',
  ...
  // --- Phase-usage signals ---
  {
    ...
    replacement:
      'respect reduced motion unless it is non-decorative or a verified reactive parent supplies static output',
